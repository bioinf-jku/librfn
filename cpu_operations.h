...
extern void ssymm_(const char *side, const char *uplo, const int *m,
                   const int *n, const float *alpha,
                   const float *a, const int *lda,
                   const float *b, const int *ldb,
                   const float *beta, float *c, const int *ldc);

extern void saxpy_(const int *n, const float *alpha, const float *dx,
            const int *incx, float *dy, const int *incy);
extern int spotrf_(const char *uplo, int *n, float *a, int * lda, int *info);
extern int spotrs_(const char *uplo, int *n, int *nrhs, float * a, int *lda,
                   float *b, int *ldb, int *info);
extern int sposv_(const char *uplo, int *n, int *nrhs, float * a, int *lda,
                   float *b, int *ldb, int *info);
...
void axpy(const int n, const float alpha, const float *dx,
                 const int incx, float *dy, const int incy)  const{
...
int potrs(const char *uplo, int n, int nrhs, float* a, int lda,
                 float *b, int ldb, int *info) const {
